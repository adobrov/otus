...
fun validationLockCorrect(command: TrackCommand, processor: TrackTicketProcessor) = runTest {
...
fun validationLockEmpty(command: TrackCommand, processor: TrackTicketProcessor) = runTest {
    val ctx = TrackContext(
        command = command,
        operationState = TrackOperationState.NONE,
        workMode = TrackWorkMode.TEST,
